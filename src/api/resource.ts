...
export function addPublicResourceToMyResources(resourceId: number): Promise<DbResource> {
...
export function getMyResourceDetail(resourceId: number): Promise<DbResourceDetail> {
