...
export function getAdminUsers(params?: GetAdminUsersParams): Promise<PaginatedUsers> {
  return request.get('/admin/users', { params })
}

export function getAdminResources(params?: GetAdminResourcesParams): Promise<PaginatedResources> {
  return request.get('/admin/resources', { params })
}

export function getAdminLearningPaths(params?: GetAdminPathsParams): Promise<PaginatedPaths> {
