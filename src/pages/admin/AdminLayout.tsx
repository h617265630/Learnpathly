...
import { LayoutDashboard, Users, FolderOpen, BookOpen, BarChart3 } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-stone-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-stone-500 mt-2">You need admin privileges to access this page.</p>
          <Link to="/home" className="mt-4 inline-block text-amber-600 hover:underline">
            Go home
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      ...
      <aside className="w-64 shrink-0 bg-stone-900 p-5 flex flex-col">
        <div className="mb-6">
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-500 mb-1">Admin</p>
          <h2 className="text-xl font-black text-white font-serif">Dashboard</h2>
        </div>
