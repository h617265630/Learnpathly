...
import { createLearningPath, createLearningPathWithCategory } from '@/api/learningPath'
...
export default function CreatePath() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      let created: any
      if (pathMeta.categoryId != null) {
        created = await createLearningPathWithCategory({
          ...payload,
          category_id: pathMeta.categoryId,
        })
      } else {
        created = await createLearningPath(payload)
      }
  ...
  const canSubmit = pathMeta.title.trim() && pathMeta.categoryId != null && !creating
