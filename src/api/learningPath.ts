...
export function getPublicLearningPathDetail(id: number): Promise<PublicLearningPathDetail> {
...
export function getMyLearningPathDetail(id: number): Promise<MyLearningPathDetail> {
...
export function attachPublicLearningPathToMe(id: number): Promise<AttachLearningPathResult> {
