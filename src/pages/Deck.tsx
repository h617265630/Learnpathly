...
const sampleCards = [
  { front: 'What is a list comprehension in Python?', back: 'A concise way to create lists using [expr for item in iterable]' },
  { front: 'What is the time complexity of dict lookup?', back: 'O(1) on average, O(n) worst case' },
  { front: 'What is the difference between a stack and a queue?', back: 'Stack: LIFO, Queue: FIFO' },
]
