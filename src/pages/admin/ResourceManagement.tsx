  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-stone-900">Resource Management</h1>
          <p className="text-sm text-stone-500 mt-1">Manage platform resources</p>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b bg-stone-50">
              ...
              <th className="px-4 py-3 text-left font-medium text-stone-600">Platform</th>
              <th className="px-4 py-3 text-left font-medium text-stone-600">Category</th>
              <th className="px-4 py-3 text-left font-medium text-stone-600">Saves</th>
              <th className="px-4 py-3 text-left font-medium text-stone-600">Trending</th>
            ...
            {loading ? (
              ...
              resources.map((resource) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-stone-600">{resource.platform || '-'}</td>
                  <td className="px-4 py-3 text-stone-600">{resource.category_name || '-'}</td>
                  <td className="px-4 py-3 text-stone-600">{resource.save_count.toLocaleString()}</td>
