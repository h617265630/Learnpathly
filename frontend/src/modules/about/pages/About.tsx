        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <p className="text-base leading-relaxed text-stone-600 max-w-lg">
              Learnpathly is a personal learning platform. We help you turn
              scattered resources—videos, articles, links—into clear, actionable
              paths you can actually finish.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="col-span-12 md:col-span-5">
            <div className="sticky top-24">
              ...
              <p className="text-sm leading-relaxed text-stone-500 mb-6">
                Browser bookmarks pile up. YouTube watch-later becomes
                watch-never. Articles are saved and forgotten. Learning happens
                in fragments—and without a clear structure, progress is
                invisible and motivation fades.
              </p>
              <p className="text-sm leading-relaxed text-stone-500">
                Learnpathly gives you a framework: turn any topic into a path,
                add resources in order, and track your progress as you go. Not
                just a library—a system for finishing what you start.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 sm:col-span-4 group relative">
                <div className="relative pt-0">
                  ...
                  <p className="text-sm leading-relaxed text-stone-500">
                    Import videos, articles, documents, and links. Keep them in
                    one organized library instead of scattered browser tabs.
                  </p>
                  <Link
                    to="/about/resources"
                    className="inline-flex items-center gap-1 mt-4 text-[11px] font-bold uppercase tracking-widest text-emerald-600 hover:text-emerald-700 transition-colors"
                  >
                    How it works
              ...
              <div className="col-span-12 sm:col-span-4 group relative">
                <div className="relative pt-0">
                  ...
                  <p className="text-sm leading-relaxed text-stone-500">
                    Drag resources into a path, reorder steps, and shape a
                    learning rhythm that fits your goal and schedule.
                  </p>
                  <Link
                    to="/about/learning-paths"
              ...
              <div className="col-span-12 sm:col-span-4 group relative">
                <div className="relative pt-0">
                  ...
                  <p className="text-sm leading-relaxed text-stone-500">
                    Track progress per resource and see completion at a glance.
                    Learning stays continuous, not fragmented.
                  </p>
                  <Link
                    to="/about/progress"
                    className="inline-flex items-center gap-1 mt-4 text-[11px] font-bold uppercase tracking-widest text-sky-600 hover:text-sky-700 transition-colors"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 mt-0.5">
                      Save quick ideas and turn them into resources later.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 mt-0.5">
                      Choose what you share and what stays personal.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 mt-0.5">
                      Browse public paths and resources from other learners.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 mt-0.5">
                      Record progress per step and see overall completion.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 pb-20">
        <div className="max-w-3xl">
          <blockquote className="text-2xl md:text-3xl font-light leading-snug text-stone-700">
            ...
            it. A learning path isn't a rigid curriculum; it's a
            <span className="font-semibold text-sky-700"> map</span> that keeps
            you oriented when the terrain gets steep."
          </blockquote>
          <p className="mt-6 text-sm text-stone-400">
            — Learnpathly, Design Principles
          </p>
        </div>
      </section>
    </div>
