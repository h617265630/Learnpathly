      ...
      <main className="mx-auto max-w-3xl px-4 py-8 space-y-8">
        <section className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Button className="rounded-none bg-amber-500 text-white hover:bg-amber-600">Primary</Button>
            <Button variant="outline" className="rounded-none">Outline</Button>
            <Button size="sm" className="rounded-none bg-stone-900 text-white">Small</Button>
            <Button size="lg" className="rounded-none bg-amber-500 text-white hover:bg-amber-600">Large</Button>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="max-w-sm space-y-3">
            ...
            <Input placeholder="With border-stone-300" className="rounded-none border-stone-300" />
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <Card className="rounded-none p-6">
            ...
            <p className="mt-2 text-sm text-stone-500">Card content goes here.</p>
          </Card>
        </section>
      </main>
    </div>
